...
export const isValidPincode = (data) => {
    if (typeof data == "number" && pincodeRegex.test(data)) return true
    return false
}


export const isValidObjectId = (data) => {
...
export const isValidStatus = (data) => {
